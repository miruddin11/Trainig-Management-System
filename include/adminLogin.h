...
public:
    void createSchedule()       //UTC-001 & AD-001
    {
        ...
        ofstream f1("D:/Training-Schedule-Management-main/Training-Schedule-Management-main/Project_Flies/data/schedule.csv", ios::app);
    ...
    void updateSchedule()       //UTC-002 & AD-002
    {
        ...
        file.open("D:/Training-Schedule-Management-main/Training-Schedule-Management-main/Project_Flies/data/schedule.csv", ios::in);
        int count = 0;
        vector<string> v;
        ...
        file.open("D:/Training-Schedule-Management-main/Training-Schedule-Management-main/Project_Flies/data/schedule.csv", ios::out | ios::trunc);
    ...
    void allotTrainer()         //UTC-003 & AD-003
    {
        ...
        ifstream f2("D:/Training-Schedule-Management-main/Training-Schedule-Management-main/Project_Flies/data/schedule.csv");
        while (f2 >> batchID >> technology >> startDate >> endDate >> nod >> venueDetail >> nop >> month)
        {
            ...
            ofstream f3("D:/Training-Schedule-Management-main/Training-Schedule-Management-main/Project_Flies/data/trainerallotment.csv", ios::app);
    ...
    void generateReport()           //UTC-004 & AD-004
    {
        ...
        ifstream f3("D:/Training-Schedule-Management-main/Training-Schedule-Management-main/Project_Flies/data/schedule.csv");
